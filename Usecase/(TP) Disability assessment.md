...
3.11 |Select any one radio button for question **Do you have difficulty seeing, even if wearing glasses?***|Radio button is selected|| ✅ ❌
3.12 |Select any one radio button for question **Do you have difficulty hearing, even if using a hearing aid(s)?***|Radio button is selected|| ✅ ❌
3.13 |Select any one radio button for question **Do you have difficulty walking or climbing steps?***|Radio button is selected|| ✅ ❌
3.14 |Select any one radio button for question **Do you have difficulty remembering or concentrating?***|Radio button is selected|| ✅ ❌
3.15 |Select any one radio button for question **Do you have difficulty with self-care, such as washing all over or dressing?***|Radio button is selected|| ✅ ❌
3.16 |Select any one radio button for question **Using your usual language, do you have difficulty communicating, for example understanding or being understood?***|Radio button is selected|| ✅ ❌
